...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StreamSetup) DeepCopyInto(out *StreamSetup) {
	*out = *in
	if in.From != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StreamSetup.
func (in *StreamSetup) DeepCopy() *StreamSetup {
	if in == nil {
		return nil
	}
	out := new(StreamSetup)
